<template>
    <div class="o-hero-item-detail">
        <div class="o-hero-item-detail__container">
            <div class="o-hero-item-detail__image loading-image">
                <div v-if="images && images.find(image => image.id === item[0].id_image_hero)" class="o-hero-item-detail__image-lazyload">
                    <img class="o-hero-item-detail__image-file lazyload-file"
                        ...
                        :data-srcset="`
                            https://image.frytolnacestach.cz/storage/${images.find(image => image.id === item[0].id_image_cover).source + images.find(image => image.id === item[0].id_image_cover).name}-374.webp 374w,
                            https://image.frytolnacestach.cz/storage/${images.find(image => image.id === item[0].id_image_cover).source + images.find(image => image.id === item[0].id_image_cover).name}-575.webp 575w,
                            https://image.frytolnacestach.cz/storage/${images.find(image => image.id === item[0].id_image_cover).source + images.find(image => image.id === item[0].id_image_cover).name}-767.webp 767w,
                            https://image.frytolnacestach.cz/storage/${images.find(image => image.id === item[0].id_image_cover).source + images.find(image => image.id === item[0].id_image_cover).name}-991.webp 991w,
                            https://image.frytolnacestach.cz/storage/${images.find(image => image.id === item[0].id_image_cover).source + images.find(image => image.id === item[0].id_image_cover).name}-1139.webp 1139w,
                            https://image.frytolnacestach.cz/storage/${images.find(image => image.id === item[0].id_image_cover).source + images.find(image => image.id === item[0].id_image_cover).name}-1219.webp 1219w,
                            https://image.frytolnacestach.cz/storage/${images.find(image => image.id === item[0].id_image_cover).source + images.find(image => image.id === item[0].id_image_cover).name}-1399.webp 1399w,
                            https://image.frytolnacestach.cz/storage/${images.find(image => image.id === item[0].id_image_cover).source + images.find(image => image.id === item[0].id_image_cover).name}-1920.webp 1920w
                            `"
