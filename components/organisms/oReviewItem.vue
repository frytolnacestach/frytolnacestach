<template>
    <section class="t-section my-2 -p0">
        <div class="t-section__inner">
            ...
            <mHeadline title="Byl jsi tu? Tak napiš recenzi." perex="Ale nejdříve se musíš přihlásit ke svému účtu." styleAlign=" -p-left" styleThema=" -world" styleGap="" v-if="numberReviews !== 0 && account.length === 0 && newReview === false && statusAccount !== 2" />
            <mHeadline title="Byl jsi tu? Tak napiš recenzi." perex="Ale nejdříve si musíš aktivovat účet." styleAlign=" -p-left" styleThema=" -world" styleGap="" v-if="numberReviews !== 0 && account.length !== 0 && newReview === false && statusAccount === 2" />
            <mHeadline title="Byl jsi tu? Tak napiš recenzi." perex="Ještě nikdo tu nenapsal recenzi, buď první." styleAlign=" -p-left" styleThema=" -world" styleGap="" v-if="numberReviews === 0 && account.length !== 0 && newReview === false && statusAccount !== 2" />
            <mHeadline title="Byl jsi tu? Tak napiš recenzi." perex="Ale nejdříve se musíš přihlásit ke svému účtu." styleAlign=" -p-left" styleThema=" -world" styleGap=" mb-2" v-if="numberReviews === 0 && account.length === 0 && newReview === false" />
            <mHeadline title="Byl jsi tu? Tak napiš recenzi." perex="Ještě nikdo tu nenapsal recenzi, buď první ale nejdříve si aktivuj svůj účet" styleAlign=" -p-left" styleThema=" -world" styleGap="" v-if="numberReviews === 0 && account.length !== 0 && newReview === false && statusAccount === 2" />
            ...
            <!-- SECTION - Form Review -->
            <oFormReviewItem :IDplace="IDplace" :type="type" :newReview="newReview" v-if="myReview.length === 0 && account.length !== 0 && statusAccount !== 2" @update="addReviewUpdate" />
