<template>
    <div class="js_o-popup-cookies o-popup-cookies">
        <div class="o-popup-cookies__outer">
            <div class="o-popup-cookies__inner">
                <div class="js_o-popup-cookies__page--welcome o-popup-cookies__page o-popup-cookies__page--welcome open">
                    ...
                    <div class="o-popup-cookies__buttons">
                        <a class="js_o-popup-cookies__button--setting o-popup-cookies__button o-popup-cookies__button--setting">Upravit preference</a>
                        <a class="js_o-popup-cookies__button--all o-popup-cookies__button">Přijmám vše</a>
                    </div>
                </div>
                <div class="js_o-popup-cookies__page--setting o-popup-cookies__page o-popup-cookies__page--setting">
                        ...
                        <div class="o-popup-cookies__items">
                            <div class="o-popup-cookies__item">
                                <div class="o-popup-cookies__header">
                                    ...
                                    <span class="o-popup-cookies__setting o-popup-cookies__setting--active"></span>
                                </div>
                    ...
                    <div class="o-popup-cookies__buttons">
                        <a class="js_o-popup-cookies__button--technical o-popup-cookies__button o-popup-cookies__button--technical">Povolit pouze nezbytné</a>
                        <a class="js_o-popup-cookies__button--select o-popup-cookies__button o-popup-cookies__button--select">Povolit vybrané</a>
                        <a class="js_o-popup-cookies__button--all o-popup-cookies__button">Přijmám vše</a>
                    </div>
                </div>
            </div>
