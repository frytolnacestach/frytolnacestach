                    ...
                    <div class="o-article-list__item-inner">
                        <div class="o-article-list__image">
                            <div class="o-article-list__image-file" v-bind:style="{ 'background-image': 'url(' + post.imageList + ')'}">
                                <NuxtLink class="o-article-list__image-link" :to="'/clanky/' + post.idname"></NuxtLink>
                            </div>
                        </div>
                        <div class="o-article-list__text">
                            <h3 class="o-article-list__title">
                                <NuxtLink class="o-article-list__title-link" :to="'/clanky/' + post.idname">{{ post.name }}</NuxtLink>
                            </h3>
                            <p class="o-article-list__perex">
                                <NuxtLink class="o-article-list__perex-link" :to="'/clanky/' + post.idname">{{ post.perex }}</NuxtLink>
                            </p>
                        </div>
                    </div>
                </div>
