<template>
    <section class="t-component-skeleton">
        ...
        <!-- SHOW - skeleton -->
        <SkeletonOrganismsVideoList :styleThema="(styleThema ? styleThema : '')" :skeletonThema="(skeletonThema ? skeletonThema : '')" :skeletonNumber="skeletonNumber" v-if="videos === null && skeleton" />
        <!-- SHOW - skeleton END -->
                                ...
                                <div :class="'o-video-list__image loading-image ' + (styleThemaLoading ? styleThemaLoading : '')">
                                    <div v-if="images && images.find(image => image.id === video.id_image)" class="o-video-list__image-lazyload">
                                        <AtomsImage 
                                            ...
                                            cssClassComponent="o-video-list"
                                        />
                                    </div>
