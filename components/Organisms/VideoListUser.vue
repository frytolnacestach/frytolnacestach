<template>
    <section class="t-component-skeleton">
        ...
        <!-- SHOW - skeleton -->
        <SkeletonOrganismsVideoListUser :styleThema="(skeletonThema ? skeletonThema : '')" :skeletonNumber="skeletonNumber" v-if="filteredVideos && filteredVideos.length === 0 && skeleton" />
        <!-- SHOW - skeleton END -->
