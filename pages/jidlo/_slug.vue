...
<script>
    ...
    export default {
        ...
        head() {
            let metaSeoTags = this.food[0].seo_tags.map(item => item.tag).join(", ")
            ...
            return {
                ...
                meta: [
                    ...
                    { name: 'keywords', content: `${this.food[0].name + metaSeoTags + ', Jídla, Tradiční jídlo, informace o jídle, plánuj cestu, cestovatelský portál, cestování, svět'}` },
