...
<script>
    ...
    export default defineComponent({
        ...
        head() {
            ...
            // title
            title = `Články od ${(this.user && this.user.length > 0) ? this.user[0].nickname : 'Uživatel'} | Frytol na cestách`
            ...
            // keywolds
            keywords = `${(this.user && this.user.length > 0) ? this.user[0].nickname : 'Uživatel' + ', články, cestovatel, uživatel, cestování, svět, rady, cestovatelský portál'}`
            ...
            // ogUrl
            ogUrl = `${process.env.baseUrl}/cestovatel/${(this.user && this.user.length > 0) ? this.user[0].slug : 'slug'}/clanky`
