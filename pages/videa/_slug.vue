        ...
        async asyncData({ $axios, params }) {
            ...
            while (!success) {
                try {
                    ...
                    const placeRegion = await $axios.$get(`https://frytolnacestach-api.vercel.app/api/places-region-id/${video[0].id_region}`)
                    ...
                    const placeSpot = await $axios.$get(`https://frytolnacestach-api.vercel.app/api/places-spot-id/${video[0].id_spot}`)
                    ...
                    data = { video, placeContinent, placeState, placeRegion, placeCity, placeSpot, imageVideo, imageContinent, imageState, imageRegion, imageCity, imageSpot }
