...
<script>
    ...
    export default {
        ...
        head: {
            ...
            meta: [
                { hid: 'description', name: 'description', content: 'Jaké Řetězce kde najdete? To zjistíte na této stránce cestovatelského portálu Frytol na cestách.' },
                { name: 'keywords', content: `Řetězce, výrobky, tradiční výroba, informace o výrobcích, plánuj cestu, cestovatelský portál, cestování, svět` },
                { property: 'og:image', content: 'https://image.frytolnacestach.cz/storage/main/og-default.png' },
                { hid: 'og:title', content: 'Řetězce | Cestovatelský portál Frytol na cestách' },
                { hid: 'og:description', content: 'Jaké Řetězce kde najdete? To zjistíte na této stránce cestovatelského portálu Frytol na cestách.' },
                { hid: 'og:url', content: `${process.env.baseUrl}/retezec` },
