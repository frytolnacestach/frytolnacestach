        ...
        head() {
            return {
                ...
                meta: [
                    ...
                    { hid: 'og:description', content: `${this.place[0].information_chatgpt ? this.place[0].information_chatgpt.slice(3, 163) : this.place[0].name ? this.place[0].name : 'Kontinent'}` },
        ...
        async asyncData({ $axios, params }) {
            ...
            while (!success) {
                try {
                    ...
                    data = { place, placesStates, videos, posts, imagePlace, imagesStates, imagesVideos, imagesPosts }
