                        ...
                        <div class="t-section__inner">
                            <div class="t-grid -place-main-with-aside">
                                <div class="t-grid__section -main">
                                    ...
                                    <OrganismsPlaceTeaserList :headline="'Jaké místa vidět ve státě ' + place[0].name" :IDplace="place[0].id" :IDplaceShow="place[0].id" type="spots" typePage="state" typeShow="spots" styleGap=" mt-2 mb-4 pt-1" />
                                    <OrganismsPlaceTeaserList :headline="'Jaké regiony vidět ve státě ' + place[0].name" :IDplace="place[0].id" :IDplaceShow="place[0].id" type="regions" typePage="state" typeShow="regions" styleGap=" mt-2 mb-4 pt-1" />
                                    <OrganismsPlaceTeaserList :headline="'Jaké města vidět ve státě ' + place[0].name" :IDplace="place[0].id" :IDplaceShow="place[0].id" type="cities" typePage="state" typeShow="cities" styleGap=" mt-2 mb-4 pt-1" />
                                ...
                                <div class="t-grid__section -aside-content">
                                    ...
                                    <OrganismsSidebarEvent :place="place[0].id" type="state" />
...
<script setup>
    ...
    let preTitle = ''
    let activeTab = 'co-videt'
    let activeTabName = 'Co vidět'
    let showHero = true
    // DATA API
    const place = ref([])
    ...
    const loadData = async () => {
        ...
        if (place.value && place.value.length > 0) {
            ...
            // Meta
            headMeta.title = `${tabLabel} ve státě ${(place && place.value.length > 0 && place.value[0].name) ? place.value[0].name : 'Stát'} | Cestovatelský portál Frytol na cestách`
            headMeta.description = ((place && place.value.length > 0 && place.value[0].information_author?.length > 0) ? place.value[0].information_author[0].text.replace(/<\/?[^>]+(>|$)/g, '').slice(0, place.value[0].information_author[0].text.lastIndexOf(' ', 160)) : (place && place.value.length > 0 && place.value[0].information_chatgpt) ? place.value[0].information_chatgpt.replace(/<\/?[^>]+(>|$)/g, '').slice(0, place.value[0].information_chatgpt.lastIndexOf(' ', 160)) : (place && place.value.length > 0 && place.value[0].name) ? place.value[0].name : 'Stát')
            if (place && place.value.length > 0 && place.value[0].seo_tags && place.value[0].seo_tags.length > 0) {
            ...
            headMeta.ogImage = `${(place && place.value.length > 0 && place.value[0].id_image_hero && imagePlace.value && imagePlace.value.length > 0) ? 'https://image.frytolnacestach.cz/storage/' + imagePlace.value.find(image => image.id === place.value[0].id_image_hero).source + imagePlace.value.find(image => image.id === place.value[0].id_image_hero).name + '.jpg' : 'https://image.frytolnacestach.cz/storage/main/og-default.png'}`
            headMeta.ogTitle = `${tabLabel} ve státě ${(place && place.value.length > 0 && place.value[0].name) ? place.value[0].name : 'Stát'} | Cestovatelský portál Frytol na cestách`
            headMeta.ogDescription = ((place && place.value.length > 0 && place.value[0].information_author?.length > 0) ? place.value[0].information_author[0].text.replace(/<\/?[^>]+(>|$)/g, '').slice(0, place.value[0].information_author[0].text.lastIndexOf(' ', 160)) : (place && place.value.length > 0 && place.value[0].information_chatgpt) ? place.value[0].information_chatgpt.replace(/<\/?[^>]+(>|$)/g, '').slice(0, place.value[0].information_chatgpt.lastIndexOf(' ', 160)) : (place && place.value.length > 0 && place.value[0].name) ? place.value[0].name : 'Stát')
            ...
            // Script
            headJsonld.name = (place && place.value.length > 0 && place.value[0].name) ? place.value[0].name : ""
            headJsonld.description = ((place && place.value.length > 0 && place.value[0].information_author?.length > 0) ? place.value[0].information_author[0].text.replace(/<\/?[^>]+(>|$)/g, '') : (place && place.value.length > 0 && place.value[0].information_chatgpt) ? place.value[0].information_chatgpt.replace(/<\/?[^>]+(>|$)/g, '') : "")
            ...
            headJsonld.area.value = (place && place.value.length > 0 && place.value[0].area) ? place.value[0].area : ""
            headJsonld.population.value = (place && place.value.length > 0 && place.value[0].population) ? place.value[0].population : ""
        }

        // SET PAGE
        preTitle = `${activeTabName} ve státě`
    }
