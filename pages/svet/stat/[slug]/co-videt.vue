                        ...
                        <div class="t-section__inner">
                            <div class="t-grid -place-main-with-aside">
                                ...
                                <div class="t-grid__section -aside-content">
                                    ...
                                    <oSidebarEvent :place="place[0].id" type="state" />
        ...
        methods: {
            async fetchData() {
                ...
                if (this.place && this.place.length > 0) {
                    ...
                    // Meta
                    this.headMeta.title = `${tabLabel} ve státě ${placeName} | Cestovatelský portál Frytol na cestách`
                    ...
                    this.headMeta.ogTitle = `${tabLabel} ve státě ${placeName} | Cestovatelský portál Frytol na cestách`
