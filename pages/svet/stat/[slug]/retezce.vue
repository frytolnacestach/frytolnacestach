...
<script setup>
    ...
    let preTitle = ''
    let activeTab = 'retezce'
    let activeTabName = 'Řetězce'
    let showHero = true
    // DATA API
    const place = ref([])
    ...
    const loadData = async () => {
        ...
        if (place.value && place.value.length > 0) {
            ...
            if (place.value[0].seo_tags && place.value[0].seo_tags.length > 0) {
                ...
                headMeta.keywords = (place.value[0].name ? place.value[0].name : '') + metaSeoTags + ', stát, řetězce, cestování, svět, cestovatelský portál, která města tu jsou, plánování cesty, dovolená, pravidla cesty, o státu'
            } else {
                headMeta.keywords = (place.value[0].name ? place.value[0].name : '') + ', stát, řetězce, cestování, svět, cestovatelský portál, která města tu jsou, plánování cesty, dovolená, pravidla cesty, o státu'
            }
