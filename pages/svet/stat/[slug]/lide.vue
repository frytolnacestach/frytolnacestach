...
<script setup>
    ...
    const loadData = async () => {
        ...
        if (place.value && place.value.length > 0) {
            ...
            // Meta
            headMeta.title = `Jací jsou ${tabLabel} ve státě ${(place && place.value.length > 0 && place.value[0].name) ? place.value[0].name : 'Stát'} | Cestovatelský portál Frytol na cestách`
            ...
            headMeta.ogTitle = `Jací jsou ${tabLabel} ve státě ${(place && place.value.length > 0 && place.value[0].name) ? place.value[0].name : 'Stát'} | Cestovatelský portál Frytol na cestách`
        ...
        // SET PAGE
        preTitle = `Jací jsou ${activeTabName} ve státě`
    }
