        ...
        methods: {
            async fetchData() {
                ...
                if (this.place && this.place.length > 0) {
                    ...
                    // Meta
                    this.headMeta.title = `Jací jsou ${tabLabel} ve státě ${placeName} | Cestovatelský portál Frytol na cestách`
                    ...
                    this.headMeta.ogTitle = `Jací jsou ${tabLabel} ve státě ${placeName} | Cestovatelský portál Frytol na cestách`
