        ...
        methods: {
            async fetchData() {
                ...
                if (this.place && this.place.length > 0) {
                    ...
                    // Meta
                    this.headMeta.title = `${tabLabel} použivané ve státě ${this.place[0].name} | Cestovatelský portál Frytol na cestách`
                    ...
                    this.headMeta.ogTitle = `${tabLabel} použivané ve státě ${this.place[0].name} | Cestovatelský portál Frytol na cestách`
