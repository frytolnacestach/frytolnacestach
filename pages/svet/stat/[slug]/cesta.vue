...
<script setup>
    ...
    const loadData = async () => {
        ...
        if (place.value && place.value.length > 0) {
            ...
            // Meta
            headMeta.title = `${tabLabel} do státu ${(place && place.value.length > 0 && place.value[0].name) ? place.value[0].name : 'Stát'} | Cestovatelský portál Frytol na cestách`
            ...
            headMeta.ogTitle = `${tabLabel} do státu ${(place && place.value.length > 0 && place.value[0].name) ? place.value[0].name : 'Stát'} | Cestovatelský portál Frytol na cestách`
        ...
        // SET PAGE
        preTitle = `${activeTabName} do státu`
    }
