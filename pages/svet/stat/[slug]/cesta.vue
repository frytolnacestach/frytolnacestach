        ...
        methods: {
            async fetchData() {
                ...
                if (this.place && this.place.length > 0) {
                    ...
                    // Meta
                    this.headMeta.title = `${tabLabel} do státu ${this.place[0].name} | Cestovatelský portál Frytol na cestách`
                    ...
                    this.headMeta.ogTitle = `${tabLabel} do státu ${this.place[0].name} | Cestovatelský portál Frytol na cestách`
