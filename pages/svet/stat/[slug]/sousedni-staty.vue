        ...
        methods: {
            async fetchData() {
                ...
                if (this.place && this.place.length > 0) {
                    ...
                    // Meta
                    this.headMeta.title = `${tabLabel} státu ${placeName} | Cestovatelský portál Frytol na cestách`
                    ...
                    this.headMeta.ogTitle = `${tabLabel} státu ${placeName} | Cestovatelský portál Frytol na cestách`
