                                                ...
                                                <div class="t-grid__section -main">
                                                    ...
                                                    <section class="t-section -p0 -px-world my-2">
                                                        <div class="t-section__inner">
                                                            ...
                                                            <OrganismsCoverNeighboring :items="placesStatesNeighboring" :images="imagesStatesNeighboring" v-if="placesStatesNeighboring" />
                                                        </div>
                                                    </section>
        ...
        methods: {
            async fetchData() {
                ...
                if (place[0].ids_neighboring_countries !== null ) {
                    ...
                    const responsePlacesStatesNeighboring = await fetch(`https://api.frytolnacestach.cz/api/places-states-array?showType=list&id=${idsNeighboringCountries.join(',')}`)
                    this.placesStatesNeighboring = await responsePlacesStatesNeighboring.json()
                } else {
                    this.placesStatesNeighboring = null
                }
                // Images
                ...
                if (placesStatesNeighboring) {
                    ...
                    const responseImagesStatesNeighboring = await fetch(`https://api.frytolnacestach.cz/api/images-array?id=${imagesplaceStatesNeighboringID.join(',')}`)
                    this.imagesStatesNeighboring = await responseImagesStatesNeighboring.json()
                } else {
                    this.imagesStatesNeighboring = null
                }
                ...
                if (this.place && this.place.length > 0) {
                    ...
                    // Meta
                    this.headMeta.title = `${tabLabel} státu ${this.place[0].name} | Cestovatelský portál Frytol na cestách`
                    ...
                    this.headMeta.ogTitle = `${tabLabel} státu ${this.place[0].name} | Cestovatelský portál Frytol na cestách`
