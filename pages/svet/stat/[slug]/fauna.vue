                                        ...
                                        <div class="t-section__inner">
                                            <div class="t-grid -place-main-with-aside">
                                                <div class="t-grid__section -main">
                                                    ...
                                                    <!-- SECTION - Fauna list -->
                                                    <OrganismsCoverItemState type="fauna" title="Nebezpečná Fauna ve státě" perex="Představujeme vám nebezpečná zvířata, která obývají tuto oblast, a poodhalujeme výjimečné vlastnosti a zajímavosti o nich." :placeStateName="place[0].name" :placeStateID="place[0].id" v-if="place[0].id" />
