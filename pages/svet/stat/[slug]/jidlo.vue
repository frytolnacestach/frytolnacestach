                                        ...
                                        <div class="t-section__inner">
                                            <div class="t-grid -place-main-with-aside">
                                                <div class="t-grid__section -main">
                                                    ...
                                                    <!-- SECTION - Food -->
                                                    <OrganismsCoverItemState type="jidlo" title="Tradiční jídla ve státě" perex="Ponořte se do bohaté tradice a ochutnejte neodolatelná tradiční jídla, která vám přiblíží autentickou chuť a atmosféru této fascinující destinace." :placeStateName="place[0].name" :placeStateID="place[0].id" v-if="place[0].id" />
                                                    <!-- SECTION - Food END -->
    ...
    const loadData = async () => {
        ...
        if (place.value && place.value.length > 0) {
            ...
            if (place.value[0].seo_tags && place.value[0].seo_tags.length > 0) {
                ...
                headMeta.keywords = (place.value[0].name ? place.value[0].name : '') + metaSeoTags + ', stát, tradiční kuchyně, jídlo, cestování, svět, cestovatelský portál, která města tu jsou, plánování cesty, dovolená, pravidla cesty, o státu'
            } else {
                headMeta.keywords = (place.value[0].name ? place.value[0].name : '') + ', stát, tradiční kuchyně, jídlo, cestování, svět, cestovatelský portál, která města tu jsou, plánování cesty, dovolená, pravidla cesty, o státu'
            }
