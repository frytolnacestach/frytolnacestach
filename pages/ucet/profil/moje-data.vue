...
<script setup>
    ...
    let headMeta = reactive({
        ...
        ogTitle: 'MOJE DATA | Cestovatelský portál Frytol na cestách',
        ogDescription: 'Moje data na cetovatelském portálu Frytol na cestách.',
        ogUrl: `https://www.frytolnacestach.cz/ucet/profil/moje-data`,
        ogType: 'website',
    })
    let headLink = ref([
