                ...
                <div class="t-grid -account">
                    ...
                    <div class="t-grid__section -content">
                        ...
                        <section class="t-section -padding-x -p0 pb-4" v-if="placesContinents[0]">
                            <div class="t-section__inner">
                                <mHeadline title="Kontinety které jsem navštívil" styleThema=" -account" styleAlign="" styleGap="" />
                        ...
                        <section class="t-section -padding-x -p0 pb-4" v-if="placesStates[0]">
                            <div class="t-section__inner">
                                <mHeadline title="Státy které jsem navštívil" styleThema=" -account" styleAlign="" styleGap="" />
                        ...
                        <section class="t-section -padding-x -p0 pb-4" v-if="placesCities[0]">
                            <div class="t-section__inner">
                                <mHeadline title="Města které jsem navštívil" styleThema=" -account" styleAlign="" styleGap="" />
                        ...
                        <section class="t-section -padding-x -p0 pb-4" v-if="placesRegions[0]">
                            <div class="t-section__inner">
                                <mHeadline title="Regiony které jsem navštívil" styleThema=" -account" styleAlign="" styleGap="" />
                        ...
                        <section class="t-section -padding-x -p0 pb-4" v-if="placesSpots[0]">
                            <div class="t-section__inner">
                                <mHeadline title="Místa které jsem navštívil" styleThema=" -account" styleAlign="" styleGap="" />
...
export default {
    ...
    head: {
        title: 'MÍSTA CO JSEM NAVŠTÍVIL | Frytol na cestách',
        meta: [
            ...
            { hid: 'og:title', content: 'Místa co jsem navštívil' },
