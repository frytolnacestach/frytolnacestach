                    ...
                    <div class="t-section__inner">
                        <div class="t-grid -account">
                            ...
                            <div class="t-grid__section -content">
                                ...
                                <section class="t-section -padding-x -p0">
                                    <div class="t-section__inner">
                                        <MoleculesHeadline title="Smazání účtu" perex="Pro zrušení účtu nás prosím kontaktujte na admin@frytolnacestach.cz. Za nedlouho vám toto umožní jedno tlačítko." styleThema=" -account -blue" styleAlign="" styleGap="" />
                                    </div>
                                </section>
