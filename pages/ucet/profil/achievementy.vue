    ...
    export default defineComponent({
        ...
        setup() {
            let headMeta = reactive({
                ...
                ogTitle: 'ACHIEVEMENTY | Cestovatelský portál Frytol na cestách',
                ogDescription: 'Získané achievementy na cetovatelském portálu Frytol na cestách.',
                ogUrl: `https://www.frytolnacestach.cz/ucet/profil/achievementy`,
                ogType: 'website',
            })
