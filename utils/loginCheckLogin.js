export async function loginCheckLogin($router) {
    const localStorageuserEmail = localStorage.getItem('useruserEmail')
    ...
    if (localStorageuserEmail && localStorageuserEmail != "undefined") {
        try {
            ...
            if (response.ok) {
                ...
                localStorage.setItem("accountEmail",localStorageuserEmail)
                ...
                //Cookies - write
                document.cookie = "FNCaccountEmail=" + localStorageuserEmail + ";" + expires;
            ...
            } else if (response.userStatus === 401) {
            ...
            } else if (response.userStatus === 404) {
